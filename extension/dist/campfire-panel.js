...
exports.CampfirePanel = void 0;
const vscode = __importStar(require("vscode"));
class CampfirePanel {
    extensionUri;
    static viewType = 'campfires.panel';
    view;
    ...
    getFilteredTeammates() {
        ...
        this.awarenessStates.forEach((state) => {
            ...
            if (this.filterConfig.users.length > 0) {
                if (!this.filterConfig.users.includes(state.userId))
                    return;
            }
            // Apply directory filter
            if (this.filterConfig.directories.length > 0 && state.currentFile) {
                const matchesDir = this.filterConfig.directories.some((dir) => state.currentFile.startsWith(dir));
                if (!matchesDir)
                    return;
            }
...
exports.CampfirePanel = CampfirePanel;
//# sourceMappingURL=campfire-panel.js.map