...
3. **Surface — Campfires Web App (Reel)** displays a pixel-art organization map, Fireside Panel with AI summaries, and real-time activity log.

## Stack

- TypeScript throughout (server, reel, shared)
...
- The Reel never exposes raw dev activity to non-devs — only AI-summarized project-level information
