...
This is Pass 2 of 2. Pass 1 (`specs/map-enhancements/pass1.md`) established the mock event system, animation queue, fire reactivity, sprite micro-animations, milestone celebrations, and ambient pulses. This pass builds on that foundation to add golem (agent) visual enhancements and the spark-to-golem spawn/despawn animation — the showpiece of the map.
